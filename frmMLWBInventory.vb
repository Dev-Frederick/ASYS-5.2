...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmMLWBInventory))
        ...
        'cboReceiver
        '
        Me.cboReceiver.Location = New System.Drawing.Point(192, 40)
        Me.cboReceiver.Name = "cboReceiver"
        Me.cboReceiver.Size = New System.Drawing.Size(160, 21)
        Me.cboReceiver.TabIndex = 3
        '
        ...
        Me.CrystalReportViewer1.Size = New System.Drawing.Size(696, 312)
        ...
        Me.Controls.Add(Me.cboReceiver)
        Me.Controls.Add(Me.Label1)
        Me.Controls.Add(Me.btnprint)
        Me.Icon = CType(resources.GetObject("$this.Icon"), System.Drawing.Icon)
        Me.Name = "frmMLWBInventory"
        Me.Text = "INVENTORY BY CUSTODIAN"
...
#End Region
    ...
    Private Sub frmMLWBInventory_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            str = "select distinct rtrim(fullname) as fullname from vw_humresall where job_title in ('mlwb')"
            objclass.Command3(str)
            dr = objclass.OpenDataReader3
            While dr.Read
                Me.cboReceiver.Items.Add(UCase(dr.Item("fullname")))
            End While
            objclass.Close3()
        Catch ex As Exception
            MsgBox("frmMLWBInventory/frmMLWBInventory_Load: " & ex.Message, MsgBoxStyle.Information, TitleMsgBox)
        End Try
    End Sub
    ...
    Private Sub btnprint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnprint.Click
        Try
            ...
            oRPT.SetParameterValue("@receiver", Me.cboReceiver.SelectedItem)
        ...
        Catch ex As Exception
            MsgBox("frmMLWBInventory/btnprint_Click: " & ex.Message, MsgBoxStyle.Information, TitleMsgBox)
        End Try
    End Sub
